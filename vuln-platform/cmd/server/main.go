...
func main() {
	...
	hostResolver := importer.NewHostResolver(hostRepo)
	csvImporter := importer.NewCSVImporter(findingRepo, importRepo, extractor, hostResolver, log)
	xlsxImporter := importer.NewXLSXImporter(findingRepo, importRepo, extractor, hostResolver, log)
